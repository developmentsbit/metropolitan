     ...
     <div class="col-sm-12 col-12 p-0"  data-aos="fade-in" data-aos-duration="2000" >
       <ul class="list-group p-0">
        <li class="list-group-item font-weight-bold bg-success text-light" id="about">
          ...
          @if($data[0]->type == 1)
          @lang('frontend.exprinicipal')
          @elseif($data[0]->type == 2)
          @lang('frontend.exviceprinicipal')
          @endif
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-12 mt-3" data-aos="fade-right" data-aos-duration="2000">
            <table class="table table-bordered " id="studenttable">
              <tr>
               <td rowspan="4">
                <center><img src="{{ asset('assets/images/ex_Principal_vice_principal/')}}/{{$d->image}}" class="img-fluid" id="" style="max-height: 100px;"><br></center>
              </td>
            ...
            <tr>
              <td colspan="3"><center><a href="{{ url("exprincipalviceprincipaldetails",$d->id) }}" class="btn btn-warning text-white btn-sm float-end">@lang('frontend.detail')</a></center></td> 
            </tr>               
          </table>
