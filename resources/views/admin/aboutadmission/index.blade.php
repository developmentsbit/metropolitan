	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<h3>@lang('about_admission.managetitle')</h3><br>

				<table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
					<thead class="mythead">
						<tr>
							<th>#</th>
							<th>@lang('about_admission.title')</th>
							<th>@lang('about_admission.image')</th>
					...
					<tbody class="tbody" id="showtdata">
						...
						<tr id="tr{{ $d->id }}">
							...
							<td>
								<div class="btn-group">
									<a  class="btn btn-info border-0 edit text-light" data-toggle="modal" data-target="#exampleModalCenters" href="{{ route("aboutadmission.edit",$d->id) }}">@lang('common.edit')</a>
									<form action="{{ route('aboutadmission.destroy',$d->id) }}" method="post">
										@csrf
										@method('DELETE')
