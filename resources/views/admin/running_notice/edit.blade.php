...
<div class="container mt-2">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h3>@lang('running_notice.edittitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('running_notice.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					<div class="row myinput">
						<div class="form-group mb-3 col-md-12">
							<label>@lang('running_notice.date'): <span class="text-danger" style="font-size: 15px;">*</span></label>
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('running_notice.details'): <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group mt-2">
