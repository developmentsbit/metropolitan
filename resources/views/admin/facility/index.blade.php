            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">@lang('facilities.title')</h4>
                        ...
                        <div class="tab-content">
                                        ...
                                        @foreach ($data['facility'] as $v)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <a class="btn btn-sm btn-info" href="{{route('facilities.show',$v->id)}}" style="float:left;margin-right:10px;"><i class="fa fa-image"></i></a>
                                                    <a class="btn btn-sm btn-info" href="{{route('facilities.edit',$v->id)}}" style="float:left;margin-right:10px;"><i class="fa fa-edit"></i></a>
                                                    <form method="post" action="{{route('facilities.destroy',$v->id)}}">
                                                        @csrf
                                                        @method('DELETE')
                            ...
                            $trashed = Facility::onlyTrashed()->get();
                            @endphp
                                        ...
                                        @foreach ($trashed as $v)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <a class="btn btn-sm btn-info" href="{{route('facilities.restore',$v->id)}}" style="float:left;margin-right:10px;"><i class="fa fa-arrow-left"></i></a>
                                                    <a onclick="return confirm('Are You Sure?')" class="btn btn-sm btn-danger" href="{{route('facilities.delete',$v->id)}}" style="float:left;margin-right:10px;"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        @endif
