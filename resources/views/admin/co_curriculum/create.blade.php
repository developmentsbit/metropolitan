...
<div class="container mt-2">
		@component('components.breadcrumb')
            @slot('title')
                @lang('co_curriculum_activities.addtitle')
            @endslot
            @slot('breadcrumb1')
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h3>@lang('co_curriculum_activities.addtitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('co_curriculum_activities.store') }}" enctype="multipart/form-data">
					@csrf
